...
{
	return new Operand<int16_t>(boost::numeric_cast<int8_t>(std::stoll(value)), eOperandType::Int8);
}

IOperand const *OperandFactory::createInt32(std::string const& value) const
{
	return new Operand<int32_t>(boost::numeric_cast<int32_t>(std::stoll(value)), eOperandType::Int8);
}

IOperand const *OperandFactory::createFloat(std::string const& value) const
{
	return new Operand<float>(std::stof(value), eOperandType::Int8);
}
